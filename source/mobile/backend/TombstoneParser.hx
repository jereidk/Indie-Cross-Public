 ...
 * traces, not derived from a compiled .proto -- there's no protobuf codegen
 * in this project. If Android ever changes tombstone.proto's field numbers
 * this would need updating to match.
 *
 ...
 *
 * Ported from NightmareVision-Android-Support's mobile.backend.TombstoneParser,
 * unchanged (fully self-contained, no project-specific dependencies).
 */
