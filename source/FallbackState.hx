 ...
 * Android only). Deliberately avoids Paths/asset calls entirely -- if the
 * crash handler fires while the asset system itself is what's broken,
 * loadGraphic()/a custom font would just throw again and this screen would
 * never appear.
 *
